...
class AppStore extends Component {
    ...
    render() {
        ...
        const filteredList = appsList.filter(each => each.appName.includes(searchInput) && activeTab === each.category)
        return (
            <div className="app-container">
                ...
                <div className="tabs-container">
                    {
                        tabsList.map(each => <TabItem tabDetails={each} changeTab={this.changeTab} isActive={activeTab === each.tabId} />)
                    }
                </div>
                <div className='apps'>
                    {
                        filteredList.map(each => <AppItem appDetails={each} />)
                    }
                </div>
            </div>
        )
